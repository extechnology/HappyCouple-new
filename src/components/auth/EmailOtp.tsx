...
import { useEmailVerification, useResendOtp } from "../../services/auth/mutations";
...
export default function EmailOtp({ isOpen, setIsOpen, RegisterData, reset }: EmailOtpProps) {
    ...
    // Email Verification
    const { mutate, isPending: isverifying } = useEmailVerification()
        ...
        mutate(formdata, {
            ...
            onSuccess: (response: any) => {
                ...
                if (response.status >= 200 && response.status <= 300) {
                    ...
                    toast.success("Registration Success", { description: "You have successfully Registered", duration: 5000 })
                    reset()
                    setIsOpen(false)
                    setTimeout(() => {
        ...
        resendOtp(formdata, {
            ...
            onSuccess: (response) => {
                ...
                if (response.status >= 200 && response.status <= 300) {
                    ...
                    toast.success("OTP Sent", { description: "OTP has been sent to your email", duration: 5000 })
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                >
                                    <Button
                                        ...
                                        className={`${otpExpired || isverifying || isResending ? "bg-gray-400 hover:cursor-not-allowed py-6" : "hover:cursor-pointer w-full py-6 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center"} `}
                                    >
                                    ...
                                    <Button
                                        type="button"
                                        variant="default"
                                        className="text-white bg-black font-semibold py-6 hover:cursor-pointer"
